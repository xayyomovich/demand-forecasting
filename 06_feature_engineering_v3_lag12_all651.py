...
selected_parts = forecastable_parts["Part Number"]

model_data = monthly_part_demand[
    monthly_part_demand["Part Number"].isin(selected_parts)
].copy()
...
all_parts = sorted(selected_parts.unique())
...
# ============================================================
# 7. LAG FEATURES INCLUDING LAG 12
# ============================================================
...
model_data["lag_12"] = model_data.groupby("Part Number")["net_qty"].shift(12)
...
# ============================================================
# 10. ANALYSIS-ONLY HIGH DEMAND FLAG
# ============================================================
...
# ============================================================
# 11. REMOVE ROWS WITHOUT ENOUGH HISTORY
# ============================================================
...
output_file = "outputs/xlsx/06_feature_engineering_v3_lag12_all651_report.xlsx"
...
feature_summary = pd.DataFrame({
    ...
    "value": [
        ...
        "This version uses all forecastable parts and includes lag_12."
    ]
})

...
# ============================================================
# 06b_feature_engineering_v4_no_lag24.py
#
# Purpose:
# Create a stronger modelling dataset from 2023-2026 data.
#
# Difference from previous v4:
# - Removes lag_24
#
# Why:
# lag_24 gives two-year seasonal signal, but with only 37 months
# it removes too many rows. This version keeps lag_12 and lag_13
# for yearly seasonality while preserving more training data.
# ============================================================
...
output_file = os.path.join(output_folder, "06b_feature_engineering_v4_no_lag24_report.xlsx")
output_csv = os.path.join(output_folder, "06b_feature_engineered_v4_no_lag24.csv")
...
summary = pd.DataFrame({
    ...
    "value": [
        ...
        ", ".join(test_months),
        len(feature_columns),
        "Uses 2023-2026 data, 1001 parts, no lag_24, keeps lag_12/lag_13 for yearly seasonality."
    ]
})
